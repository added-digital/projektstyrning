...
const ChartCore = memo(function ChartCore({
  ...
  const yScales = useMemo(() => {
    ...
    return buildYScalesForLines({
      ...
      resolveDomain: (dataKeys) => {
        // LOKAL PATCH (upstream-bugg i bklit): vid stacked måste
        // y-domänen utgå från summan per stapel, inte största enskilda
        // serievärde — annars ritas varje segment ~N× för högt och stapeln
        // rinner ut ur grafen. Behåll vid omkörning av `shadcn add`.
        if (stacked) {
  ...
  }, [data, innerHeight, isHorizontal, lines, valueScale, stacked, maxValue]);
